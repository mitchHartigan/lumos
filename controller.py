...
class SimpleFadeController(object):
    def __init__(self, update_interval, client_wrapper):
        ...
        self.gradient2 = [
                          ...
                          [255, 255, 0], [255, 255, 0], [255, 255, 0], [255, 255, 0], [255, 255, 0],
                          [255, 255, 0], [255, 255, 0], [255, 255, 0], [255, 255, 0], [255, 255, 0],
                          [255, 200, 0], [255, 200, 0], [255, 180, 0], [255, 160, 0], [255, 100, 0],
                          [200, 60, 0], [200, 60, 0], [200, 60, 0], [200, 60, 0], [200, 60, 0],
                          [240, 60, 0], [240, 60, 0], [240, 60, 0], [240, 60, 0], [240, 60, 0],
                          [200, 60, 0], [200, 60, 0], [200, 60, 0], [200, 60, 0], [200, 60, 0],
                          [200, 60, 0], [200, 60, 0], [200, 80, 0], [140, 120, 0], [80, 160, 0],
    ...
    def UpdateDmx(self):
        ...
        # universe_x_offset is the amount of time we want to wait before starting to update this array.
        # Ie, this code is called every 25ms (UPDATE_INTERVAL), and it waits for five
        # intervals before outputting the first elem to the array. Length is the number of pixels in the strip.
        ...
        if(self._iterable >= universe_one_offset):
            if (self._iterable >=universe_one_offset + universe_one_length):
                ...
                while x < 6:
                    ...
                    x += 1
                # Prevents negative length values, by not subtracting past 0.
                ...
                # Adds a pixel (or set of pixels) to the array if so.
