...
class SimpleFadeController(object):
    def __init__(self, update_interval, client_wrapper):
        ...
        # Testing gradient
        self._strip_test_gradient_math = array('f', [217,120,0,206.15,114,12.75,195.3,108,25.5,184.45,102,38.25,173.6,96,51,162.75,90,63.75,151.9,84,76.5,141.05,78,89.25,130.2,72,102,119.35,66,114.75,108.5,60,127.5,97.65,54,140.25,86.8,48,153,75.95,42,165.75,65.1,36,178.5,54.25,30,191.25,43.4,24,204,32.55,18,216.75,21.7,12,229.5,10.85,6,242.25,0,0,255])
